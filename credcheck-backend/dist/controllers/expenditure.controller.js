...
const addExpenditureDetail = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const expenditureDetails = yield expenditureService.addExpenditureDetail(req.body);
...
const getExpenditureByCardId = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const expenditureDetails = yield expenditureService.fetchExpenditureByCardId(req.params.id);
