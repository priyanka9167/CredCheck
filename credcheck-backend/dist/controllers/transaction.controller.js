...
const addTransactionDetail = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const transactionDetails = yield transactionService.addTransactionDetail(req.body);
...
const getTransactionByCardId = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const transactionDetails = yield transactionService.fetchTransactionByCardId(req.params.id);
